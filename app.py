...
<div class="main-header">
    ...
    <p>Tác giả: Tống Thị Hồng - Trường Tiểu học Quyết Tiến - ĐT: 0904 122 211</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Tống Thị Hồng - Trường Tiểu học Quyết Tiến - ĐT: 0904 122 211</div>", unsafe_allow_html=True)
